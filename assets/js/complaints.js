$(document).ready(function () {
    ...
    function complaintMatchesFilters(complaint, searchTerms, filters) {
        ...
        if (filters.language !== "" && (complaint.language || "English") !== filters.language) {
    ...
    function getTotalPages(totalItems) {
        ...
        return Math.max(1, Math.ceil(totalItems / dashboardState.complaintsPerPage));
    ...
    function getPageSlice(complaints, page) {
        ...
        return complaints.slice(startIndex, startIndex + dashboardState.complaintsPerPage);
    ...
    function updateResultsSummary(filteredCount, totalCount, searchTerms, pageStart, pageEnd) {
        ...
        if (filteredCount === 0) {
            ...
            summaryText = "Showing " + filteredCount + " of " + totalCount + " complaints";
    ...
    function renderPagination(totalItems) {
        ...
        $("#paginationNextBtn").prop("disabled", dashboardState.currentPage === totalPages);
    ...
    function goToPage(page) {
        ...
        renderComplaints(dashboardState.filteredComplaints, getSearchTerms(), false);
    ...
    function updateSelectCounts(selector, counts, allLabel) {
        ...
        $(selector + " option").each(function () {
            ...
            if (value === "") {
                ...
                $(this).text(allLabel + " (" + dashboardState.allComplaints.length + ")");
    ...
    function updateFilterSelectStates() {
        ...
        $("#categoryFilter").toggleClass("filter-active", $("#categoryFilter").val() !== "");

        $("#statusFilter").toggleClass("filter-active", $("#statusFilter").val() !== "");

        $("#languageFilter").toggleClass("filter-active", $("#languageFilter").val() !== "");
    ...
    function renderActiveFilterChips() {
        ...
        $("#activeFiltersBar").toggleClass("visible", hasActiveFilters(searchTerms));
    ...
    function buildComplaintCard(complaint, searchTerms) {
        ...
        let previewText = complaint.complaintText || complaint.generatedComplaint || "";

        let preview = highlightSearchTerms(truncateText(previewText, 120), searchTerms);

        let categoryLabel = highlightSearchTerms(complaint.category || "Complaint", searchTerms);

        let statusLabel = highlightSearchTerms(complaint.status || "Pending", searchTerms);
        ...
        let fullComplaint = escapeHtml(complaint.generatedComplaint || complaint.complaintText || "");
    ...
    function showEmptyState(message) {
        ...
        let hasFilters = hasActiveFilters(getSearchTerms()) && dashboardState.allComplaints.length > 0;
    ...
    function renderComplaints(complaints, searchTerms, resetPage) {
        ...
        if (dashboardState.filteredComplaints.length === 0) {
            ...
            updateResultsSummary(0, dashboardState.allComplaints.length, searchTerms, 0, 0);
        ...
        let startIndex = (dashboardState.currentPage - 1) * dashboardState.complaintsPerPage + 1;
    ...
    function filterComplaints(keepPage) {
        ...
        let matchedComplaints = dashboardState.allComplaints.filter(function (complaint) {
    ...
    function loadComplaints() {
        ...
        complaintsCollection
            ...
            .then(function (snapshot) {
                ...
                dashboardState.allComplaints = sortComplaintsByDate(dashboardState.allComplaints);
    ...
    function deleteComplaint(complaintId) {
        ...
        complaintsCollection
            ...
            .then(function () {
                ...
                dashboardState.allComplaints = dashboardState.allComplaints.filter(function (complaint) {
    ...
    function initializeFilters() {
        ...
        $("#categoryFilter, #statusFilter, #languageFilter, #dateFilter").change(function () {
    ...
    function initializeCardActions() {
        ...
        $("#complaintsContainer").on("click", ".delete-btn", function () {
            ...
            let confirmDelete = window.confirm("Are you sure you want to delete this complaint?");
